...
\begin{figure}[h!]
  ...
  \begin{tikzpicture}[scale=.5]
      ...
      \draw [thick, join=round, line cap=round, dash pattern=on 0pt off 4\pgflinewidth] ( \x+\b*\y , -\c*\x - \b*\c*\y + \y) -- (0,0) --  (\x , \y);
      \draw [thick, join=round, line cap=round, dash pattern=on 4\pgflinewidth off 8\pgflinewidth ] ( \x+\b*\y , -\c*\x - \b*\c*\y + \y) --  (\bcps*\x/\s + \bcps*\b*\y/2/\s, -\bcps*\c*\x/2/\s - \bcps*\b*\c*\y/2/\s + \bcps*\y/\s) --  (\x , \y);
...
\begin{figure}[h!]
  ...
  \begin{tikzpicture}[scale=.3]
    ...
    \begin{scope}[shift={(13,-13)}]
      ...
      \draw [thick, join=round] (\x , \y) -- ( \x+\b*\y , \y) -- ( \x+\b*\y , -\c*\x - \b*\c*\y + \y);
      \draw [thick, join=round, line cap=round, dash pattern=on 0pt off 4\pgflinewidth on 4\pgflinewidth off 4\pgflinewidth] ( \x+\b*\y , -\c*\x - \b*\c*\y + \y) -- (0,0) --  (\x , \y);
      \draw [thick, fill=white] ( \x+\b*\y , -\c*\x - \b*\c*\y + \y) circle (5pt);
    \end{scope}
