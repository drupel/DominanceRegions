...
\begin{document}
  ...
  \begin{proof}
    ...
    Similarly, using $\phi_{t_1}(\lambda)=(-\lambda_1,c\lambda_1+\lambda_2)$ for $\lambda\in\cI$, together with the basic Chebyshev recursion and the equality $\phi_{2j+1}=\phi_{t_1}\phi_{t_2}^j$ gives the given formula for $\phi_{t_{2j+1}}$ from that of $\phi_{t_{2j}}$.
  \end{proof}
