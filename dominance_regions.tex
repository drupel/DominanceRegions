...
\begin{document}
  ...
  The dominance poligon pointed at $\lambda=(\lambda_1,\lambda_2)$ is the region defined by the following six inequalities:
  \begin{align}
    \frac{\lambda _1 \left(b c+\sqrt{b c (b c-4)}\right)}{2 b}+\frac{x \left(-b c-\sqrt{b c (b c-4)}\right)}{2 b}+\lambda _2\geq y
    \\
    \frac{\lambda _1 \left(b c-\sqrt{b c (b c-4)}\right)}{2 b}+\frac{x \left(\sqrt{b c (b c-4)}-b c\right)}{2 b}+\lambda _2\leq y
    \\
    \frac{\lambda _1 \left(b c+\sqrt{b c (b c-4)}\right)}{2 b}+\frac{2 c x}{b c+\sqrt{b c (b c-4)}}+\lambda _2\geq y
    \\
    -\frac{\lambda _1 \left(b c+\sqrt{b c (b c-4)}\right)}{2 b}-\frac{1}{2} \lambda _2 \left(b c+\sqrt{b c (b c-4)}-2\right)+\frac{2 c x}{b c-\sqrt{b c (b c-4)}}\geq y
    \\
    -\frac{\lambda _1 \left(b c+\sqrt{b c (b c-4)}\right)}{2 b}-\frac{1}{2} \lambda _2 \left(b c+\sqrt{b c (b c-4)}-2\right)+\frac{x \left(\sqrt{b c (b c-4)}-b c\right)}{2 b}\geq y
    \\
    \frac{\left(-b c-\sqrt{b c (b c-4)}\right) \left(\frac{\left(b c+\sqrt{b c (b c-4)}\right) \left(b c \lambda _1+\lambda _1 \sqrt{b c (b c-4)}+2 b \lambda_2\right)}{4 b c}+x\right)}{2 b}\leq y
  \end{align}
