...
\begin{document}
  ...
  Maybe this one:
  \begin{align}
    (b c-\sqrt{b c (b c-4)})(x-\lambda_1)+2b(y-\lambda_2) & \geq0
    \\
    (b c+\sqrt{b c (b c-4)})(x-\lambda_1)-2b(y-\lambda_2) & \geq (b c+\sqrt{b c (b c-4)})b\lambda_2 
    \\
    -(b c-\sqrt{b c (b c-4)})(x-\lambda_1)-2b(y-\lambda_2)& \geq 2bc\lambda_1+(b c+\sqrt{b c (b c-4)})b\lambda_2
    \\
    -2c(x-\lambda_1)-(b c-\sqrt{b c (b c-4)})(y-\lambda_2)& \geq0
    \\
    2c(x-\lambda_1)-(b c+\sqrt{b c (b c-4)})(y-\lambda_2) & \geq -(b c+\sqrt{b c (b c-4)})c\lambda_1
    \\
    2c(x-\lambda_1)+(b c-\sqrt{b c (b c-4)})(y-\lambda_2) & \geq -(b c+\sqrt{b c (b c-4)})c\lambda_1-2cb\lambda_2
  \end{align}
