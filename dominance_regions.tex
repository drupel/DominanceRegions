...
\begin{document}
  ...
  \begin{lemma}
    Any eigenvector of $\phi_{t_2}$ is a multiple of one of the vectors $(2b,-bc\pm\sqrt{bc(bc-4)})$.
  \end{lemma}
  \begin{proof}
    ...
    In this region, $\phi_{t_2}$ is linear with eigenvalue $\alpha$ satisfying $\alpha^2-(bc-2)+1=0$, i.e. $\alpha=\frac{bc-2\pm\sqrt{bc(bc-4)}}{2}$.
