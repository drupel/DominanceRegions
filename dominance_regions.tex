...
\begin{document}
  ...
  That is, each basis element can be written in the form $\sum\limits_{a_1,a_2 \ge 0} c_{a_1,a_2} x_1^{\lambda_1-ba_1} x_2^{\lambda_2+ca_2}$ with $c_{0,0}=1$ for some $\lambda\in\ZZ^2$ and this structure reproduces after expanding in terms of any pair $\{x_k,x_{k+1}\}$.
