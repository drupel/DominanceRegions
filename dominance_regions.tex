...
\begin{document}
  ...
  \begin{proof}
    ...
    \[(u_{3,+}u_{2k+1,-}-u_{2,-}u_{2k,+})x+(u_{2,+}u_{2k+1,-}-u_{1,-}u_{2k,+})y\le u_{i+1,-}\lambda_1+u_{i,+}\lambda_2,\]
    ...
    \[(-u_{1,+}u_{2k+1,-}+u_{0,-}u_{2k,+})x+(u_{2,+}u_{2k+1,-}-u_{1,-}u_{2k,+})y\le u_{i+1,-}\lambda_1+u_{i,+}\lambda_2,\]
