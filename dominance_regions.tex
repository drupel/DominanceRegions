...
\section{Chebyshev Polynomials}
  ...
  \end{remark}
  \begin{proof}
    We first compute the limits for arbitrary positive real numbers $b$ and $c$ with $bc>4$; the remaining case will then follow by taking the limit as $bc$ approaches $4$.
