...
\begin{document}
  ...
  Write $D^{max}=D^{max}[a_1,a_2]$ for the maximal Dyck path in the lattice rectangle $[0,a_1]\times[0,a_2]$, i.e. $D^{max}$ never crosses above the diagonal line joining $(0,0)$ to $(a_1,a_2)$ and any lattice point above $D_{max}$ also lies above the diagonal.
  ...
  \begin{definition}
    ...
    %        y = (a2 - a1*(self._r1*self._r2-sqrt(self._r1*self._r2*(self._r1*self._r2-4)))/(2*self._r2))/(1-(self._r1*self._r2-sqrt(self._r1*self._r2*(self._r1*self._r2-4)))/(self._r1*self._r2+sqrt(self._r1*self._r2*(self._r1*self._r2-4))))
    %    corner = (y*(self._r1*self._r2-sqrt(self._r1*self._r2*(self._r1*self._r2-4)))/(2*self._r1),y)
  \end{definition}
  \begin{remark}
