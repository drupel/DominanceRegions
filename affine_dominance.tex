...
\section{Iterated Mutations}
  ...
  Given a sequence of signs $\beps=(\varepsilon_1,\varepsilon_2,\ldots)$ with $\varepsilon_i\in\{\pm\}$, define an infinite quiver $\widehat{Q}_\beps$ with vertices $(k,s)\in [n]\times\ZZ_{\ge0}$ and the following arrows:
  \begin{itemize}
